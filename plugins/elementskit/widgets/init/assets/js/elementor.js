    ...
    let i = {
        ...
        Unfold: function(t) {
            var i = t.find(".ekit-unfold-btn"),
                ...
                o = n.data("config");
            o.collapse_height >= s.outerHeight() ? (i.hide(), a.addClass("active")) : (i.show(), a.removeClass("active")), i.off("click").on("click", (function() {
                var t = this,
                    i = e(this);
        ...
        Table: function(i) {
            ...
            if (t.isEditMode() && (n = t.config.elements.data[i.data("model-cid")].attributes), i.find(".ekit_table").length > 0) {
                ...
                const t = i.find(".ekit_table table"),
                    ...
                    f = t.find("thead tr");
                if (f.length) {
                    for (let e = f.children("th").length; e < p; e++) f.append("<th></th>")
                }
                t.DataTable(c)
            }
        },
