google.maps.__gjsload__('search', function(_) {
    var tra = function(a) {
        ...
        sra = function(a) {
            ...
            const d = [];
            a.lv().forEach(e => {
                e.a && e.a.length >= 2 && d.push(new ura(e, b, c))
            });
            return d
        },
        vra = class extends _.Qm {};
    var wra = {
            ["1"]: {}
        },
        ura = class {
            ...
            getAnchor() {
                if (!this.anchor) {
                    const a = 1 << this.zoom;
                    this.anchor = _.Ir(new _.Cq((this.Bn.x * 256 + this.source.a[0]) / a, (this.Bn.y * 256 + this.source.a[1]) / a)).toJSON()
                }
                return this.anchor
            }
            getCompleteBounds() {
    ...
    OH.enableFeatureMapEventsRasterOnly = OH.enableFeatureMapEventsRasterOnly;
    _.tn(OH.prototype, {
        map: _.Gt
    });
